import {
  mysqlTable, int, varchar, boolean, timestamp,
  mysqlEnum, index, json, text, float,
...
export const questions = mysqlTable("questions", {
  ...
  nivel_dificuldade: mysqlEnum("nivel_dificuldade", ["Muito Baixa","Baixa","Média","Alta","Muito Alta"]).notNull().default("Média"),
...
// =============================================================================
export const simulationAnswers = mysqlTable("simulation_answers", {
  id: int("id").primaryKey().autoincrement(),
...
// =============================================================================
// Tabela: formulas — banco de fórmulas editável pelo admin
// =============================================================================
export const formulas = mysqlTable("formulas", {
  id: int("id").primaryKey().autoincrement(),
  secao: varchar("secao", { length: 100 }).notNull(),   // ex: "Álgebra"
  cor: varchar("cor", { length: 20 }).notNull().default("#01738d"),
  titulo: varchar("titulo", { length: 200 }).notNull(),
  formula: text("formula").notNull(),                   // LaTeX: $$...$$
  ...
  idxSecao: index("idx_secao").on(t.secao),
  idxOrdem: index("idx_ordem").on(t.ordem),
}));
